...
singularity exec envs/singularity/genericdata/ch-env_latest.sif /bin/bash -c "samtools view -bSu results/bowtie2_01/bowtie2_01/control_tnt/beads_Col-B_v3a/beads_Col-B_v3a.sam | samtools sort -o results/bowtie2_01/control_tnt/beads_Col-B_v3a/beads_Col-B_v3a.bam -T results/bowtie2_01/control_tnt/beads_Col-B_v3a/beads_Col-B_v3a.bam"
...
singularity exec $WD/envs/singularity/genericdata/ch-env_latest.sif /bin/bash -c "samtools view -u -q 30 results/bowtie2_01/control_tnt/beads_Col-B_v3a/beads_Col-B_v3a.bam 1 2 3 4 5 | samtools sort -o results/bowtie2_01/control_tnt/beads_Col-B_v3a/beads_Col-B_v3a.bam -T results/bowtie2_01/control_tnt/beads_Col-B_v3a/beads_Col-B_v3a.q30nuc.bam"
